...
path = "c:/Users/User/devops-netology/devops-netology/"

bash_command = ["cd c:/Users/User/devops-netology/devops-netology", "git status"]
result_os = os.popen(' && '.join(bash_command)).read()
#is_change = False
for result in result_os.split('\n'):
    if result.find('modified') != -1:
...
```
python.exe C:/Users/User/test.py
c:/Users/User/devops-netology/devops-netology/python.md
c:/Users/User/devops-netology/devops-netology/testtest.txt
...
### Вывод скрипта при запуске при тестировании:
```
pythonProject2>main.py C:\Users\User\devops-netology\devops-netology
C:\Users\User\devops-netology\devops-netologypython.md
C:\Users\User\devops-netology\devops-netologytesttest.txt
```
